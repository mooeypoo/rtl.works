...
<div class="inner cover">
	...
	<p>Probably not. Not to judge you, specifically, of course - but that's just the reality of the web. Most website don't have proper right-to-left support, and only few even try. But there are <a href="http://ltr.wtf/">many reasons</a> why you <strong>should</strong> consider right-to-left support, despite <a href="http://ltr.wtf/explained/rtl-support-history/">how challenging it may be.</a></p>
	...
	<p>The purpose of this analysis tool is not to tell you whether your site is working in right to left (we can't really know) -- it's to point out potential issues you should beware of when designing for internationalization in mind.</p>
	...
	<ul>
		<li>Searching for the existence of 'dir' attribute in html and body tags</li>
		<li>Searching stylesheets for:
			<ul>
				<li>The existence direction: style attributes</li>
